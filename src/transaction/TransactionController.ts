...
> {
   ...
   *
   * @param remoteTxs - The transactions fetched from etherscan, the blockchain or other source.
   * @param localTxs - The transactions currently stored in the state of the controller.
   * @param stateReconcileMethod - The strategy used to reconcile the transactions.
   * @returns A tuple that includes a boolean indicating whether an update is required, and the
